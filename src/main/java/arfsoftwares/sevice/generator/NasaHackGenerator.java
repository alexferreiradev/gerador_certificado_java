...
import arfsoftwares.exception.LargeNameException;
import arfsoftwares.helper.StreamHelper;
import arfsoftwares.sevice.dto.CertificatorGeneratorCommand;
import arfsoftwares.sevice.generator.token.TokenGenerator;
import arfsoftwares.util.GeneratorUtil;
...
public class NasaHackGenerator implements CertificateGenerator {
	...
	public NasaHackGenerator(TokenGenerator tokenGenerator) {
